...
const StoryEditor = () => {
  ...
  return (
    <div className="text-slate-700 dark:text-slate-200">
      {/* Chapter Selection */}
      <div className="flex items-center gap-4 mb-4 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-slate-600 scrollbar-track-gray-100 dark:scrollbar-track-slate-800 pb-2 w-[90%]">
